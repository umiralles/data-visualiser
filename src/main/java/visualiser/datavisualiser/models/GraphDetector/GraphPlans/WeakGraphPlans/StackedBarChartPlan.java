...
public class StackedBarChartPlan extends WeakGraphPlan {
    ...
    private StackedBarChartPlan(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts) {
        super(k1Att, k2Att, orderedAtts);
    }

    public static WeakGraphPlan getDummyInstance() {
        return new StackedBarChartPlan(null, null, null);
    }

    @Override
    public WeakGraphPlan getInstance(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts) {
        return new StackedBarChartPlan(k1Att, k2Att, orderedAtts);
    }
