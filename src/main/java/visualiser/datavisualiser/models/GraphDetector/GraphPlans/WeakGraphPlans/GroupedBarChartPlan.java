...
public class GroupedBarChartPlan extends WeakGraphPlan {
    ...
    private GroupedBarChartPlan(PrimaryKey k1, PrimaryKey k2,
    ...
    public static WeakGraphPlan getDummyInstance() {
        return new GroupedBarChartPlan(null, null, null, null);
    }

    @Override
    public WeakGraphPlan getInstance(PrimaryKey k1, PrimaryKey k2,
                                     List<Attribute> orderedMandAtts, List<Attribute> orderedOptionalAtts) {
        return new GroupedBarChartPlan(k1, k2, orderedMandAtts, orderedOptionalAtts);
    }
