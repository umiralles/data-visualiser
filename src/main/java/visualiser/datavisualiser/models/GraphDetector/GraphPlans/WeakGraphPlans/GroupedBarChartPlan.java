...
public class GroupedBarChartPlan extends WeakGraphPlan {
    ...
    private static final String planName = "Grouped Bar Chart";
    ...
    private GroupedBarChartPlan(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts) {
        super(k1Att, k2Att, orderedAtts);
    }

    public static WeakGraphPlan getDummyInstance() {
        return new GroupedBarChartPlan(null, null, null);
    }

    @Override
    public WeakGraphPlan getInstance(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts) {
        return new GroupedBarChartPlan(k1Att, k2Att, orderedAtts);
    }
