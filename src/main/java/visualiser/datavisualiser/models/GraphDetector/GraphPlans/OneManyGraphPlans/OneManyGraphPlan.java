...
public abstract class OneManyGraphPlan extends GraphPlan {
    ...
    OneManyGraphPlan(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts) {
        this.k1Att = k1Att;
        this.k2Att = k2Att;
    ...
    public abstract OneManyGraphPlan getInstance(Attribute k1Att, Attribute k2Att, List<Attribute> orderedAtts);
